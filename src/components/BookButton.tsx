      ...
      return (
        <Dialog.Root>
          <Dialog.Trigger asChild>
            <button className="flex min-w-[318px] cursor-pointer gap-5 rounded-lg bg-gray-700 p-5 pl-6 transition duration-200 ease-in-out hover:bg-gray-600">
              <Image
                src={img}
                alt="Image do livro"
                width={108}
              ...
              <div className="flex h-full flex-col justify-between">
                <header className="w-[150px] text-left">
          ...
          <Dialog.Portal>
            ...
            <Dialog.Content className="data-[state=open]:animate-contentShow fixed right-[0] top-[0] min-h-screen w-[660px]  bg-gray-800 px-12 focus:outline-none">
